...
//
// electron-builder's unpacked output is a second copy of server/ under
// dist-build/; linting it would report every finding twice.
config.push({ ignores: ["**/dist-build/**"] });
